...
module.exports = {
  ...
  ["link", {
    rel: "stylesheet",
    href: "https://cdn.bootcdn.net/ajax/libs/github-markdown-css/2.10.0/github-markdown.min.css"
  }]],
  dest: "public",
  base: "/",
  markdown: {
  ...
  plugins: [["vuepress-plugin-auto-sidebar", {
    ...
    // 排除无实际内容的页面
    exclude: ["/404.html"]
  }], ["autometa", autometa_options], ["vuepress-plugin-smooth-scroll"], ["vuepress-plugin-zooming", {
    delay: 1000,
    options: {
      scrollOffset: 0,
      bgColor: "#ffffff"
